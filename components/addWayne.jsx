...
import { Box, Center, Text, Stack, Textarea, Button, useColorModeValue, useToast, Heading, Input, Select } from '@chakra-ui/react';
import useAuth from "../hooks/useAuth";
import { addWayne } from "../api/wayne";
import { Icon } from '@chakra-ui/react'
import { MdFamilyRestroom } from 'react-icons/fa';
...
const AddWayne = () => {
    ...
    const handledWayneAdd = async () => {
        ...
        window.location.assign("#"); //Will update once file been created.
    };
        ...
        <Box minH={'100vh'} align={'center'} justify={'center'} bg={useColorModeValue('gray.50', 'gray.800')}>
            <Stack spacing={4} w={'full'} maxW={'md'} bg={useColorModeValue('white', 'gray.700')} rounded={'xl'} boxShadow={'lg'} p={6} my={12}>
                ...
                <Button
                    ...
                    disabled={name.length < 1 || relation.length < 1 || birth.length < 1 || discription.length < 1|| isLoading }
                    colorScheme="blue"
                    variant="solid">
